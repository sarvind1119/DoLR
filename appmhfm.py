...
system_msg_template = SystemMessagePromptTemplate.from_template(template="""Try to give results in bullets points if is a multiline answer.Answer the question as truthfully as possible using the provided context, 
